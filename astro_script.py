...
def main(gui_arguments=None):
    ...
    try:
        ...
        return "Planet not found."  ######### Default settings if no arguments are passed #########
    def_tz = DEFAULT_SETTINGS["timezone"]
    def_transits_tz = DEFAULT_SETTINGS["transits_timezone"]
    def_place_name = DEFAULT_SETTINGS["place_name"]
    def_transits_location = DEFAULT_SETTINGS["transits_location"]
    def_lat = DEFAULT_SETTINGS["latitude"]
    def_long = DEFAULT_SETTINGS["longitude"]
    def_alt = DEFAULT_SETTINGS["altitude"]
    def_imprecise_aspects = DEFAULT_SETTINGS["imprecise_aspects"]
    def_minor_aspects = DEFAULT_SETTINGS["minor_aspects"]
    def_show_brief_aspects = DEFAULT_SETTINGS["show_brief_aspects"]
    def_show_score = DEFAULT_SETTINGS["show_score"]

    def_orbs = DEFAULT_ORBS

    def_degree_in_minutes = DEFAULT_SETTINGS["degree_in_minutes"]
    def_node = DEFAULT_SETTINGS["node"]
    def_all_stars = DEFAULT_SETTINGS["all_stars"]
    def_house_cusps = DEFAULT_SETTINGS["house_cusps"]
    def_output_type = DEFAULT_SETTINGS["output_type"]

    # Default Output settings
    hide_planetary_positions = DEFAULT_OUTPUT_SETTINGS["hide_planetary_positions"]
    hide_planetary_aspects = DEFAULT_OUTPUT_SETTINGS["hide_planetary_aspects"]
    hide_fixed_star_aspects = DEFAULT_OUTPUT_SETTINGS["hide_fixed_star_aspects"]
    hide_asteroid_aspects = DEFAULT_OUTPUT_SETTINGS["hide_asteroid_aspects"]
    show_transits = DEFAULT_OUTPUT_SETTINGS["show_transits"]
    show_synastry = DEFAULT_OUTPUT_SETTINGS["show_synastry"]
    ...
    if args["Location"]:
        ...
        if latitude is None or longitude is None:
            ...
            les_html = HTML_ERROR_TEMPLATE.format(error_message=location_error_string)
            if args["Output"] == "html":
                print(les_html)
