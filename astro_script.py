...
def calculate_planetary_aspects(planet_positions, orbs, output_type, aspect_types):
    ...
    excluded_pairs = [
        ...
        {"Ascendant", "Midheaven"}, {"South Node", "North Node"}, {"Midheaven", "IC"}, {"Ascendant", "IC"}
    ]
    ...
    for i, planet1 in enumerate(planet_names):
        for planet2 in planet_names[i+1:]:
            ...
            if ( {planet1, planet2} in excluded_pairs ) or ( {planet2, planet1} in excluded_pairs ):
                continue
...
def print_aspects(aspects, planet_positions, orbs, transit_planet_positions=None, imprecise_aspects="off", minor_aspects=True, degree_in_minutes=False, house_positions=None, orb=1, type="Natal", p1_name="", p2_name="", notime=False, output="text", show_aspect_score=False, star_positions=None, complex_aspects=None, center="geocentric"):
    ...
    if output in ('text','html'):
        if type == "Asteroids":
            ...
            print(f"{p}{bold}{h3}Asteroid Transit Aspects {orb_string_transits_fast_slow}{nobold}", end="")
        elif type == "Synastry":
